...
const mockProducts = [
  ...
  },
  {
    ...
    stockCount: 60,
    deliveryTime: "2-3 Days",
    description: "Premium executive chair with high backrest and padded armrests for all-day comfort.",
    features: ["High Back", "Padded Armrests", "Swivel Base", "Lumbar Support"],
    comfortRatings: { support: 95, breathability: 80, adjustment: 70 },
    dimensions: { height: "120 cm", width: "65 cm", depth: "65 cm", weightLimit: "150 kg" },
    iconColor: "var(--color-primary)",
    image: "https://greatwallfurnitures.com/wp-content/uploads/2020/03/J109A.jpg"
  },
  {
    id: 56,
    name: "5013M Mesh Chair",
    category: "Chairs",
    price: 189,
    originalPrice: 249,
    badge: "Ergonomic",
    ...
    stockCount: 150,
    deliveryTime: "Next-Day",
    description: "Ergonomic mesh back chair providing excellent airflow and mid-back support.",
    features: ["Breathable Mesh", "Adjustable Height", "Rolling Casters", "Durable Build"],
    comfortRatings: { support: 85, breathability: 95, adjustment: 60 },
    dimensions: { height: "105 cm", width: "60 cm", depth: "60 cm", weightLimit: "120 kg" },
    iconColor: "var(--color-secondary)",
    image: "https://greatwallfurnitures.com/wp-content/uploads/2020/03/5013M.jpg"
  },
  {
    id: 57,
    name: "GYHG Task Chair",
    category: "Chairs",
    price: 149,
    originalPrice: 199,
    badge: "Value",
    ...
    stockCount: 200,
    deliveryTime: "Next-Day",
    description: "Reliable and comfortable task chair perfect for everyday office work.",
    features: ["Padded Seat", "Sturdy Frame", "Height Adjustable", "Compact"],
    comfortRatings: { support: 80, breathability: 85, adjustment: 50 },
    dimensions: { height: "100 cm", width: "55 cm", depth: "55 cm", weightLimit: "110 kg" },
    iconColor: "var(--color-primary)",
    image: "https://greatwallfurnitures.com/wp-content/uploads/2020/03/GYHG.jpg"
  },
  {
    id: 58,
    name: "GYH Manager Chair",
    category: "Chairs",
    price: 249,
    originalPrice: 329,
    badge: "Popular",
    ...
    stockCount: 85,
    deliveryTime: "2-3 Days",
    description: "Sophisticated manager chair offering a balance of style and ergonomic support.",
    features: ["Leather Finish", "Tilt Mechanism", "Wide Seat", "Heavy Duty"],
    comfortRatings: { support: 90, breathability: 75, adjustment: 80 },
    dimensions: { height: "115 cm", width: "65 cm", depth: "65 cm", weightLimit: "130 kg" },
    iconColor: "var(--color-primary)",
    image: "https://greatwallfurnitures.com/wp-content/uploads/2020/03/GYH.jpg"
  },
  {
    id: 59,
    name: "GYHH Conference Chair",
    category: "Chairs",
    price: 199,
    originalPrice: 269,
    badge: "Sleek",
    ...
    stockCount: 120,
    deliveryTime: "Next-Day",
    description: "Sleek and modern chair ideal for conference rooms and collaborative spaces.",
    features: ["Sleek Profile", "Fixed Armrests", "Smooth Glides", "Comfortable"],
    comfortRatings: { support: 85, breathability: 80, adjustment: 40 },
    dimensions: { height: "105 cm", width: "60 cm", depth: "60 cm", weightLimit: "120 kg" },
    iconColor: "var(--color-secondary)",
    image: "https://greatwallfurnitures.com/wp-content/uploads/2020/03/GYHH.jpg"
  },
  {
    id: 60,
    name: "822M Orthopedic Chair",
    category: "Chairs",
    price: 329,
    originalPrice: 429,
    badge: "Top Tier",
    ...
    stockCount: 40,
    deliveryTime: "2-3 Days",
    description: "Advanced orthopedic chair designed to maximize comfort and reduce back strain.",
    features: ["Advanced Lumbar", "Multi-tilt lock", "Premium Mesh", "Headrest"],
    comfortRatings: { support: 100, breathability: 95, adjustment: 100 },
    dimensions: { height: "125 cm", width: "65 cm", depth: "65 cm", weightLimit: "150 kg" },
    iconColor: "var(--color-primary)",
    image: "https://greatwallfurnitures.com/wp-content/uploads/2020/03/822M.jpg"
  },
  {
    id: 61,
    name: "Executive Desk 649",
    category: "Desks",
    price: 499,
    originalPrice: 649,
    badge: "Executive",
    ...
    stockCount: 45,
    deliveryTime: "2-3 Days",
    description: "Spacious and elegant executive desk featuring premium wood finish and ample storage space.",
    features: ["Premium Finish", "Cable Management", "Spacious Top", "Sturdy Build"],
    comfortRatings: { support: 0, breathability: 0, adjustment: 0 },
    dimensions: { height: "76 cm", width: "180 cm", depth: "90 cm", weightLimit: "150 kg" },
    iconColor: "var(--color-primary)",
    image: "https://greatwallfurnitures.com/wp-content/uploads/2020/03/649-14.jpg"
  },
  {
    id: 62,
    name: "HC5102 Workstation",
    category: "Desks",
    price: 349,
    originalPrice: 449,
    badge: "Modern",
    ...
    stockCount: 80,
    deliveryTime: "Next-Day",
    description: "Modern modular workstation desk perfect for collaborative office environments.",
    features: ["Modular Design", "Scratch Resistant", "Metal Legs", "Easy Assembly"],
    comfortRatings: { support: 0, breathability: 0, adjustment: 0 },
    dimensions: { height: "75 cm", width: "160 cm", depth: "80 cm", weightLimit: "120 kg" },
    iconColor: "var(--color-secondary)",
    image: "https://greatwallfurnitures.com/wp-content/uploads/2020/03/HC5102-16.jpg"
  },
  {
    id: 63,
    name: "HC5101 Compact Desk",
    category: "Desks",
    price: 249,
    originalPrice: 329,
    badge: "Compact",
    ...
    stockCount: 120,
    deliveryTime: "Next-Day",
    description: "Compact and efficient office desk designed to maximize productivity in smaller spaces.",
    features: ["Space Saving", "Durable Surface", "Sleek Profile", "Minimalist"],
    comfortRatings: { support: 0, breathability: 0, adjustment: 0 },
    dimensions: { height: "75 cm", width: "120 cm", depth: "60 cm", weightLimit: "100 kg" },
    iconColor: "var(--color-primary)",
    image: "https://greatwallfurnitures.com/wp-content/uploads/2020/03/HC5101-12.jpg"
  },
  {
    id: 64,
    name: "233 Classic Desk",
    category: "Desks",
    price: 289,
    originalPrice: 389,
    badge: "Classic",
    ...
    stockCount: 60,
    deliveryTime: "2-3 Days",
    description: "A classic, durable office desk that blends traditional aesthetics with modern functionality.",
    features: ["Classic Wood Grain", "Heavy Duty", "Storage Drawers", "Large Workspace"],
    comfortRatings: { support: 0, breathability: 0, adjustment: 0 },
    dimensions: { height: "76 cm", width: "140 cm", depth: "70 cm", weightLimit: "130 kg" },
    iconColor: "var(--color-primary)",
    image: "https://greatwallfurnitures.com/wp-content/uploads/2020/03/233-12.jpg"
  },
  {
    id: 65,
    name: "235 Professional Desk",
    category: "Desks",
    price: 399,
    originalPrice: 529,
    badge: "Pro",
    ...
    stockCount: 50,
    deliveryTime: "2-3 Days",
    description: "Professional grade office desk with integrated features for power and organization.",
    features: ["Integrated Power", "Thick Top", "Ergonomic Height", "Premium Details"],
    comfortRatings: { support: 0, breathability: 0, adjustment: 0 },
    dimensions: { height: "76 cm", width: "160 cm", depth: "80 cm", weightLimit: "150 kg" },
    iconColor: "var(--color-secondary)",
    image: "https://greatwallfurnitures.com/wp-content/uploads/2020/03/235-10.jpg"
  }
];
...
function viewProductDetail(productId) {
  ...
  window.location.href = `${baseUrl}/product-detail/?id=${productId}`;
}
