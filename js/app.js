...
const mockProducts = [
  ...
  {
    id: 9,
    name: "Heavy Duty Steel Bunk Bed",
    category: "Bunkbeds",
    price: 399,
    originalPrice: 499,
    ...
    stockCount: 150,
    deliveryTime: "Next-Day",
    description: "Built for ultimate durability, this heavy-duty industrial steel bunk bed features a reinforced frame perfect for commercial dormitories or robust home use.",
    features: ["Reinforced Steel Construction", "Integrated Safety Rails", "Built-In Ladder", "High Weight Capacity"],
  ...
  {
    id: 10,
    name: "Classic Oak Wood Bunk Bed",
    category: "Bunkbeds",
    price: 549,
    originalPrice: 699,
    badge: "Premium Feel",
    ...
    stockCount: 85,
    deliveryTime: "2-3 Days",
    description: "A timeless classic. Crafted from solid oak wood, this bunk bed brings warmth and traditional styling to any bedroom while maintaining exceptional structural integrity.",
    features: ["Solid Oak Hardwood", "Non-Toxic Varnish Finish", "Separable into Two Beds", "Slatted Mattress Support"],
  ...
  {
    id: 11,
    name: "Space-Saving Twin Metal Bunk",
    category: "Bunkbeds",
    price: 299,
    originalPrice: 399,
    badge: "Best Value",
    ...
    stockCount: 210,
    deliveryTime: "Next-Day",
    description: "Maximize your room space with this sleek, modern twin-over-twin metal bunk bed. Its minimalist profile fits perfectly in smaller rooms without feeling cramped.",
    features: ["Minimalist Metal Profile", "Quick and Easy Assembly", "Full-Length Guardrails", "No Box Spring Needed"],
