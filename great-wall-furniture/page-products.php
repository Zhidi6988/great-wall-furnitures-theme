...
<body>
      ...
      <div class="catalog-layout">
        ...
        <aside class="sidebar-filter">
          ...
          <div class="filter-section" style="background-color: hsl(var(--color-accent) / 0.05); border-radius: var(--radius-sm); padding: 16px; border: 1px solid hsl(var(--color-accent) / 0.15);">
            <h4 style="font-size: 14px; font-weight:700; color:hsl(var(--color-accent)); margin-bottom:8px; display:flex; align-items:center; gap:6px;">ðŸ“¦ Wholesaler Delivery Guarantee</h4>
  ...
  <footer class="footer">
    <div class="container">
      ...
      <div class="footer-bottom">
        ...
        <p>Comfortable Seating â€¢ High-Speed Delivery â€¢ Wholesaler Direct</p>
      </div>
    </div>
  </footer>
  ...
  <div class="drawer" id="cart-drawer">
    <div class="drawer-header">
      ...
      <button class="drawer-close" id="close-cart" aria-label="Close cart">Ã—</button>
    </div>
    ...
    <div class="drawer-footer">
      ...
      <p style="font-size:12px; color:hsl(var(--color-text-muted)); margin-bottom:16px;">âš¡ Orders inside Dubai qualify for Next-Day Cash on Delivery.</p>
  ...
  <div class="modal-overlay" id="modal-overlay">
    <div class="modal-container">
      <div class="modal-header">
        ...
        <button class="drawer-close" id="close-modal">Ã—</button>
      </div>
