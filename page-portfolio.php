  ...
  <main class="scroll-container">
    ...
    <section class="section header-section">
      <div class="header--container" style="display: flex; justify-content: space-between; width: 100%; align-items: center;">
        <h2>Great Wall</h2>
        <button id="theme-toggle-btn" aria-label="Toggle Theme" style="background: transparent; border: none; cursor: pointer; color: var(--color-text-light); pointer-events: auto; position: relative; z-index: 1000;">
